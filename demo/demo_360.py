...
def generate_camera_list(sdf_renderer):
    ...
    for idx in range(NUMBER):
        ...
        view = View(azimuth_deg, 15, 0, 2.5)
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument("--checkpoint_color", "-cc", dest="checkpoint_color", default="1999",
        help='The checkpoint weights to use. This can be a number indicated an epoch or "latest" '
        + "for the latest weights (this is the default)",
    )
    ...
    arg_parser.add_argument('--class_name', type=str, default='sofa', help='class name.')

    arg_parser.add_argument('-i', '--instance_id', type=int, default=330, help='instance id.')
    arg_parser.add_argument('--vis_folder', type=str, default='vis/demo_360', help='folder for visualization')

'''
This file was completed copied from the `occupancy networks` repo
[Link] https://github.com/autonomousvision/occupancy_networks/scripts/dataset_shapenet/get_r2n2_cameras.py
'''
import argparse
import numpy as np
